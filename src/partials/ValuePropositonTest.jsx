...
// // WealthManagementMasonry Component
// const WealthManagementMasonry = () => {
...
//   // Cards data for the Masonry grid
//   const cardsData = [
//     { 
//       id: 1, 
...
//     { 
//       id: 4, 
//       title: "Credit Portfolio Reviews", 
...
//     { 
//       id: 5, 
//       title: "Client Portfolio Reviews", 
...
//       after: "4 Hours/quarter",
//       height: 200
//     },
//   ];

//   // Render spotlight card function
...
//       <div 
//         ref={cardRef}
//         className="spotlight-card relative h-full overflow-hidden rounded-2xl bg-gray-800 p-px min-h-[200px] flex flex-col justify-between
...
//           after:bg-indigo-500 after:opacity-0 after:blur-2xl after:transition-opacity after:duration-300
...
//           <div className="flex items-center mt-6 justify-between relative z-20">
//             <div className="mr-4 flex-1">
//               <div className="text-gray-400 text-sm mb-1">Before</div>
//               <div className="text-xl md:text-3xl font-bold bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent whitespace-nowrap">
//                 {item.before}
//               </div>
//             </div>
...
//               <div className="text-xl md:text-3xl font-bold bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent whitespace-nowrap">
//                 {item.after}
//               </div>
//             </div>
//           </div>
...
//          {/* Call to action */}
//             {/* <div className="absolute w-full top-[100vh] flex justify-center items-center">
...
//         </button>
//       </div>
//        {/* <svg></svg> code - please skip this section */}
//     </div>
//   );
// };
...
//             before: "10 Hours", 
//             after: "5 Minutes",
//             height: 200  // You can adjust these heights as needed
//           },
//           { 
//             id: 2, 
//             title: "Credit Memo", 
...
//         // Render spotlight cards with the same appearance as original
//         const renderSpotlightCard = (item) => {
...
//                     600: 2,      // Two columns on small tablets
//                     1000: 2      // Two columns on desktops
//                   }}
//                   itemPadding={4}
//                   className="group"
//                 />
