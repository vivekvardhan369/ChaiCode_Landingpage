...
const GoogleGeminiEffect = ({
  ...
  return (
    <div className={`sticky top-80 ${className || ""}`}>
      <p className="text-lg md:text-7xl font-semibold pb-4 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-gray-200 to-yellow-400 leading-tight">
        {title}
      </p>
...
// Financial Analytics Showcase Component
const FinancialAnalyticsShowcase = () => {
  ...
  // Transform scroll progress into path lengths for animated effect
  ...
  return (
    ...
    >
      <GoogleGeminiEffect
        ...
        title="Transform Financial Services with AI"
        description={<>Finance professionals waste <strong className="text-blue-600">~80%</strong> of their time on
          manual, time-consuming research, monitoring, and reporting tasks.</>}
      />
      
      {/* Feature cards that appear as you scroll */}
      


      
      {/* Call to action */}
      {/* <div className="absolute w-full top-[80vh] flex justify-center items-center">
        <div className="max-w-md text-center p-8">
          <h2 className="text-2xl md:text-4xl font-bold text-white mb-6">Ready to harness the power of AI?</h2>
          <button 
                  onClick={() => {
                  ...
                  className="px-6 py-3 bg-blue-600 hover:bg-blue-400 text-white font-medium rounded-full transition-all"
                >
                  Get a demo
                </button>
        </div>
...
// Update the WealthManagementMasonry component for better card layout
const WealthManagementMasonrySection = () => {
  ...
  const cardsData = [
    { 
      ...
      before: "48+ Hours/quarter", 
      after: "4 Hours",
      height: 200 // Taller with subtitle
    },
    { 
      id: 2, 
      title: "Credit Memo", 
    ...
    { 
      ...
      before: "12 - 40 Hours", 
      after: "20 Minutes",
      height: 200 // Tallest with subtitle
    },
    { 
      id: 4, 
    ...
    { 
      ...
      before: "3-4 Hours/client", 
      after: "15 Minutes",
      height: 200
    },
    { 
      id: 6, 
      title: "New Deal Screen", 
      before: "10 Hours", 
      after: "5 Minutes",
      height: 200
    },
  ...
  // FIX: Create a SpotlightCard component outside of renderItem function
  const SpotlightCard = useCallback(({ item, index = 0 }) => {
    ...
    return (
      ...
      >
      <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950/90 p-6 md:p-8 
        ...
        <div className="flex items-center mt-4 justify-between relative z-20">
          <div className="mr-2 flex-1">
            <div className="text-gray-400 text-xs mb-1">Before</div>
            <div className="text-lg md:text-xl font-bold bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent whitespace-nowrap">
              {item.before}
            </div>
          </div>
          <div className="flex-shrink-0 mx-1 md:mx-3 flex items-center">
            <motion.div 
              className="text-blue-500 flex items-center opacity-100 transition-opacity"
              animate={{
                x: [0, 5, 0],
                scale: [1, 1.2, 1],
              }}
          ...
          <div className="ml-2 flex-1 text-right">
            ...
            <div className="text-lg md:text-xl font-bold bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent whitespace-nowrap">
              {item.after}
            </div>
          </div>
        </div>
...
// This render function now passes the index to SpotlightCard for staggered animation
const renderSpotlightCard = (item, index) => {
  return <SpotlightCard item={item} index={index} />;
};
    ...
    >
      ...
      >
        ...
        <p className="text-lg text-center text-gray-300 max-w-3xl mx-auto">
          Our AI solutions dramatically reduce the time spent on routine financial tasks,
          allowing your team to focus on high-value analysis and decision making.
        </p>
      </motion.div>
...
// Main component
const ValuePropositionMain = () => {
  return (
    <div className="bg-black">
      <WealthManagementMasonrySection />
      <FinancialAnalyticsShowcase />
    </div>
  );
};

export default ValuePropositionMain;
